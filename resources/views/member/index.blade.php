            ...
            <div class="form-container">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold header-text">Getlink Freepik giá siêu rẻ chỉ 1.000 đồng</h6>
                    </div>

                    <div class="card-body">
                        <div class="form-group green-border-focus">
                            <label class="sub-header">Dán link freepik vào ô bên dưới và nhấn nút getlink:</label>
                        ...
                        <div class="form-group" style="text-align: center;">
                            <button class="btn btn-lg btn-outline-warning btn-getlink" id="getlink_btn_freepik">
                                <img class="" width="30px" height="30px"  src="{{asset('assets-theme/img/get-link-icon.svg')}}">
                                <span class="text">GETLINK</span>
                            </button>
                            <button class="btn btn-lg btn-outline-warning btn-getlink" id="reset_btn">
                                <img class="" width="30px" height="30px"  src="{{asset('assets-theme/img/reset-icon.svg')}}">
