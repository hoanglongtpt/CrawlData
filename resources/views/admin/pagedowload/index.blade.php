                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="scroll-horizontal-preview" role="tabpanel">
                                    <div id="scroll-horizontal-datatable_wrapper"
                                        ...
                                        <form action="{{route('pagedowload.index')}}" class="mt-5 custom-form-search-admin d-flex" method="GET">
                                            <a href="{{route('pagedowload.create')}}" class="form-control btn btn-primary custom-btn-add-new">Thêm mới</a>
                                            <div class="row">
                                                <div class="col">
                                                                    ...
                                                                    <td>
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(0px, 31px);" data-popper-placement="bottom-end">
                                                                                ...
                                                                                <a href="{{route('pagedowload.edit',[$item->id])}}" class="dropdown-item">Sửa</a>
                                                                                <a href="javascript:void(0);" class="dropdown-item" onclick="{{'confirmDelete('.$item->id.')'}}">Xóa</a>
                                                                                <form id="{{'deleteForm-'.$item->id}}" action="{{ route('pagedowload.destroy',['id' => $item->id ]) }}" method="POST" style="display: none;">
                                                                                    @csrf
                                                                                    @method('DELETE')
                                                                                </form>
                                                                            </div>
