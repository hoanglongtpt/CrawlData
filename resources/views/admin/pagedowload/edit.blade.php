        ...
        <div class="container-fluid">
            <div class="row mt-3">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Chỉnh Sửa Admin</h4>
                            <div class="tab-content mt-5">
                                <div class="tab-pane show active" id="custom-styles-preview" role="tabpanel">
                                    <form action="{{route('pagedowload.update',[$item->id])}}" class="needs-validation" novalidate="" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input value="{{ old('type', $item->type) }}" name="type" type="text"
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="validationCustom02">Giá bit(1 lần tải )</label>
                                            <input value="{{ old('amount', $item->amount) }}" name="amount" type="text"
                                                class="form-control @error('amount') is-invalid @enderror"
                                                id="validationCustom01" placeholder="Giá bit(1 lần tải )" required />
                                            <div class="valid-feedback">
                                                Tốt!
                                            </div>
                                            @error('amount')
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="validationCustom02">Link web</label>
                                            <input value="{{ old('link_login', $item->link_login) }}" name="link_login" type="text"
                                                class="form-control @error('link_login') is-invalid @enderror"
                                                id="validationCustom01" placeholder="Link web" required />
                                            <div class="valid-feedback">
                                                Tốt!
                                            </div>
                                            @error('link_login')
                                        ...
                                        <button class="btn btn-primary" type="submit" fdprocessedid="j85tou">Cập
                                            nhật</button>
                                    </form>
                                </div> <!-- end preview-->
