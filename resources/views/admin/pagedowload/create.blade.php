                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content mt-5">
                                    <div class="tab-pane show active" id="custom-styles-preview" role="tabpanel">
                                        <form action="{{ route('pagedowload.store') }}" class="needs-validation"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input value="{{ old('link_login') }}" name="link_login" type="text"
                                            ...
                                            <button class="btn btn-primary" type="submit" fdprocessedid="j85tou">Thêm
                                                mới</button>
                                        </form>
                                    </div> <!-- end preview-->
