        ...
        <div class="container-fluid">
            <div class="row mt-3">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Chỉnh Sửa Người Dùng</h4>
                            <div class="tab-content mt-5">
                                <div class="tab-pane show active" id="custom-styles-preview" role="tabpanel">
                                    <form action="{{route('member.update',[$member->id])}}" class="needs-validation" novalidate="" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <div class="mb-3">
                                            <label class="form-label" for="validationCustom01">Email</label>
                                            <input value="{{ old('email', $member->email) }}" name="email" type="text"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input value="{{ old('name', $member->name) }}" name="name" type="text"
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="validationCustom02">Số dư tài khoản</label>
                                            <input value="{{ old('account_balance', $member->account_balance) }}" name="account_balance" type="text"
                                                class="form-control @error('account_balance') is-invalid @enderror"
                                                id="validationCustom01" placeholder="Số dư" required />
                                            <div class="valid-feedback">
                                                Tốt!
                                            </div>
