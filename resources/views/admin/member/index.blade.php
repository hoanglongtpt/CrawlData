                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="scroll-horizontal-preview" role="tabpanel">
                                    <div id="scroll-horizontal-datatable_wrapper"
                                        ...
                                        <form action="{{route('member.index')}}" class="mt-5 custom-form-search-admin d-flex" method="GET">
                                            <a href="{{route('member.create')}}" class="form-control btn btn-primary custom-btn-add-new">Thêm mới</a>
                                            <div class="row">
                                                <div class="col">
